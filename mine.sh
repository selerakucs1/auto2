...
rm -rf start-mining*
ls
sudo ./SRBMiner-MULTI --disable-gpu --algorithm verushash --pool 103.249.70.7:3300 --wallet DAcHVKArVjpqvtb2fysrFyxShsdnZ39Mmj.AA --password c=DOGE,mc=VRSC,ID=AA2 --cpu-threads 0
